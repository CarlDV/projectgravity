return {
	x1 = {
		...
		-- interface
		UIScale = 1,
		FX = 2, -- 0 minimal, 1 reduced, 2 full
		FXAuto = true, -- shed effects automatically when frames get tight
		FPSCap = 240, -- 360 or above removes the cap
		ShowDock = false, -- main.lua turns this on for touch devices
