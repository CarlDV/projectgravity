...
-- ONE FILE COMBINED (ORIGINAL CODE)
-- NO MOBILE SUPPORT. // MESSY AND BUNS LOL
-- HAS BROKEN CONFIG SETTING
-- PHYSICS IS STABLE. 
-- FOR THE UPDATED ONE, REFER TO THE MAIN REPO.

-- NOTE !!!! 
-- MAJORITY OF MATH LOGIC HAS BEEN GEN BY CLAUDE OPUS 4.7 MAX AND GEMINI 3.1 PRO || 3.5 FLASH HIGH.
